...
class TestOperationApi2(TestConfig):
	...
	def test_addoperation7(self):
		...
		self.assertEqual(len(data['data']['operations'][0]['object']['cars']), 2)
		self.assertEqual(len(data['data']['operations'][0]['object']['persons']), 2)

		self.assertEqual(data['data']['operations'][0]['object']['cars'][0]['model'], 'toyota', 'no car model')
		self.assertEqual(data['data']['operations'][0]['object']['cars'][0]['plate_number_numbers'], '321')
		self.assertEqual(data['data']['operations'][0]['object']['cars'][1]['brand'], 'brand', 'not same brand')
		self.assertEqual(data['data']['operations'][0]['object']['cars'][1]['plate_number_numbers'], '3241')

		self.assertEqual(data['data']['operations'][0]['object']['persons'][0]['name'], 'mustafa')
		self.assertEqual(data['data']['operations'][0]['object']['persons'][1]['name'], 'mustafa2')
